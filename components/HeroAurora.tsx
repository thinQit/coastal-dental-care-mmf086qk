...
export default function HeroAurora({
  badge = 'Built for fast-growing teams',
  headline = 'Convert More Traffic Into Revenue',
  subheadline = 'Launch a high-converting landing page in days, not weeks—designed to turn clicks into qualified leads.',
  primaryCta = { label: 'Start Free Trial', href: '#pricing' },
  secondaryCta = { label: 'See Live Demo', href: '#testimonials' },
